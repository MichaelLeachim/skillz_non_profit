 ...
 *   
 */
re_frame.loggers.loggers = (function (){var G__14128 = new cljs.core.PersistentArrayMap(null, 5, [cljs.core.cst$kw$log,console.log.bind(console),cljs.core.cst$kw$warn,console.warn.bind(console),cljs.core.cst$kw$error,console.error.bind(console),cljs.core.cst$kw$group,(cljs.core.truth_(console.group)?console.group.bind(console):console.log.bind(console)),cljs.core.cst$kw$groupEnd,(cljs.core.truth_(console.groupEnd)?console.groupEnd.bind(console):(function (){
return cljs.core.List.EMPTY;
}))], null);
return (cljs.core.atom.cljs$core$IFn$_invoke$arity$1 ? cljs.core.atom.cljs$core$IFn$_invoke$arity$1(G__14128) : cljs.core.atom.call(null,G__14128));
})();
re_frame.loggers.console = (function re_frame$loggers$console(var_args){
var args__8335__auto__ = [];
var len__8328__auto___14132 = arguments.length;
var i__8329__auto___14133 = (0);
while(true){
if((i__8329__auto___14133 < len__8328__auto___14132)){
args__8335__auto__.push((arguments[i__8329__auto___14133]));

var G__14134 = (i__8329__auto___14133 + (1));
i__8329__auto___14133 = G__14134;
continue;
} else {
}
break;
...
return re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__8336__auto__);
});
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2((function (){var G__14131 = (cljs.core.deref.cljs$core$IFn$_invoke$arity$1 ? cljs.core.deref.cljs$core$IFn$_invoke$arity$1(re_frame.loggers.loggers) : cljs.core.deref.call(null,re_frame.loggers.loggers));
return (level.cljs$core$IFn$_invoke$arity$1 ? level.cljs$core$IFn$_invoke$arity$1(G__14131) : level.call(null,G__14131));
})(),args);
});

re_frame.loggers.console.cljs$lang$maxFixedArity = (1);

re_frame.loggers.console.cljs$lang$applyTo = (function (seq14129){
var G__14130 = cljs.core.first(seq14129);
var seq14129__$1 = cljs.core.next(seq14129);
return re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(G__14130,seq14129__$1);
});
