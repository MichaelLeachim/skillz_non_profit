...
var vec__14900_14903 = clojure.data.diff(orig_db,new_db);
var only_before_14904 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14900_14903,(0),null);
var only_after_14905 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14900_14903,(1),null);
var db_changed_QMARK__14906 = (!((only_before_14904 == null))) || (!((only_after_14905 == null)));
if(db_changed_QMARK__14906){
...
re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.array_seq(["only before:",only_before_14904], 0));

re_frame.loggers.console.cljs$core$IFn$_invoke$arity$variadic(cljs.core.cst$kw$log,cljs.core.array_seq(["only after :",only_after_14905], 0));
...
var map__14913 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
...
var db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14913__$1,cljs.core.cst$kw$db);
var event = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14913__$1,cljs.core.cst$kw$event);
...
var map__14921 = cljs.core.cst$kw$coeffects.cljs$core$IFn$_invoke$arity$1(context);
...
var len__8328__auto___14924 = arguments.length;
var i__8329__auto___14925 = (0);
while(true){
if((i__8329__auto___14925 < len__8328__auto___14924)){
args__8335__auto__.push((arguments[i__8329__auto___14925]));

var G__14926 = (i__8329__auto___14925 + (1));
i__8329__auto___14925 = G__14926;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(argseq__8336__auto__);
});
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq14923){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq14923));
});
...
var event = re_frame.interceptor.get_coeffect.cljs$core$IFn$_invoke$arity$2(context,cljs.core.cst$kw$event);
var db = (function (){var or__7215__auto__ = re_frame.interceptor.get_effect.cljs$core$IFn$_invoke$arity$2(context,cljs.core.cst$kw$db);
...
var args__8335__auto__ = [];
var len__8328__auto___14932 = arguments.length;
var i__8329__auto___14933 = (0);
while(true){
if((i__8329__auto___14933 < len__8328__auto___14932)){
args__8335__auto__.push((arguments[i__8329__auto___14933]));

var G__14934 = (i__8329__auto___14933 + (1));
i__8329__auto___14933 = G__14934;
continue;
} else {
}
break;
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__8336__auto__);
});
...
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(new_db,p1__14927_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (new_db,old_db,new_ins){
return (function (p1__14928_SHARP_){
return cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(old_db,p1__14928_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq14929){
...
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__14930,G__14931,seq14929__$2);
});
