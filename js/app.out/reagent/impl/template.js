...
var G__13925 = jsprops;
(G__13925["defaultValue"] = value);

(G__13925["onChange"] = ((function (G__13925,v,value,on_change){
return (function (p1__13922_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__13922_SHARP_);
});})(G__13925,v,value,on_change))
);

(G__13925["ref"] = ((function (G__13925,v,value,on_change){
return (function (p1__13923_SHARP_){
return (this$["cljsInputElement"] = p1__13923_SHARP_);
});})(G__13925,v,value,on_change))
);
...
var vec__13932 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13932,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13932,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13932,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___13937 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___13937 == null)){
} else {
var key_13938 = temp__4661__auto___13937;
(jsprops["key"] = key_13938);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__13940 = (new reagent.impl.template.NativeWrapper());
(G__13940["name"] = c);
...
var G__13942 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__13942) : reagent.impl.template.as_element.call(null,G__13942));
} else {
...
var len__8328__auto___13948 = arguments.length;
var i__8329__auto___13949 = (0);
while(true){
if((i__8329__auto___13949 < len__8328__auto___13948)){
args__8335__auto__.push((arguments[i__8329__auto___13949]));

var G__13950 = (i__8329__auto___13949 + (1));
i__8329__auto___13949 = G__13950;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq13946){
var G__13947 = cljs.core.first(seq13946);
var seq13946__$1 = cljs.core.next(seq13946);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__13947,seq13946__$1);
});
...
break;
default:
var G__13954 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__13954;
continue;
...
var n__8138__auto___13957 = a.length;
var i_13958 = (0);
while(true){
if((i_13958 < n__8138__auto___13957)){
(a[i_13958] = reagent.impl.template.as_element((a[i_13958])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8138__auto___13960 = a.length;
var i_13961 = (0);
while(true){
if((i_13961 < n__8138__auto___13960)){
var val_13962 = (a[i_13961]);
if((cljs.core.vector_QMARK_(val_13962)) && ((reagent.impl.template.key_from_vec(val_13962) == null))){
(o["no-key"] = true);
} else {
}

(a[i_13961] = reagent.impl.template.as_element(val_13962));

var G__13963 = (i_13961 + (1));
i_13961 = G__13963;
continue;
} else {
}
...
var ctx = ({});
var vec__13967 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13967,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__13967,(1),null);
...
var G__13971 = (cljs.core.count(argv) - first_child);
switch (G__13971) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__13971){
